// <copyright file="CodeFixVerifier.cs" company="Timo Virkki">
...
namespace TestHelper
{
    ...
    public abstract partial class CodeFixVerifier : DiagnosticVerifier
    {
        ...
        /// <summary>
        /// Called to test a codefix when applied on the inputted string as a source
        /// </summary>
        ...
        {
            this.VerifyFix(this.GetDiagnosticAnalyzer(), this.GetCodeFixProvider(), oldSource, newSource, codeFixIndex, allowNewCompilerDiagnostics);
        }
